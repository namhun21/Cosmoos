...
def animationleft(firstindex,secondindex,thirdindex,fourthindex,move,frame):
    ...
    Make_Clothes_Image.make_Clothes_Image(clothes[firstindex],(100-11*move, 100-11*move),y[0],y[1],x[0],x[1],frame)
    Make_Clothes_Image.make_Clothes_Image(clothes[secondindex],(150-5-5*move,125-7-2*move),y[2],y[3],x[2],x[3],frame)
    Make_Clothes_Image.make_Clothes_Image(clothes[thirdindex],(100+5+5*move,100+7+2*move),y[4],y[5],x[4],x[5],frame)
    Make_Clothes_Image.make_Clothes_Image(clothes[fourthindex],(10+10*move,10+10*move),y[6],y[7],x[6],x[7],frame)
